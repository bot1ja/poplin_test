describe("E2E test - New orders", () => {
  ...
  it("TC-004 | User Starts a new Order with an exist profile for a Small Bag, basic coverage and Express delivery.", () => {
    cy.logInUser();
    cy.startNewOrder("Express Delivery", "#stepper-small", "Basic");
    cy.logOutUser();
  });

  it("TC-005 | User Starts a new Order With an exist profile for a Small Bag, Premium coverage and Express delivery.", () => {
    cy.logInUser();
    cy.startNewOrder("Express Delivery", "#stepper-regular", "Premium");
    cy.logOutUser();
  });

  it("TC-006 | User Starts a new Order With an exist profile for a Large Bag, Premium+ coverage and Express delivery.", () => {
    cy.logInUser();
    cy.startNewOrder("Express Delivery", "#stepper-large", "Premium+");
    cy.logOutUser();
  });

  it("TC-007 | User Starts a new Order with an exist profile for a Large Bag, Premium+ coverage and Express delivery.", () => {
    cy.logInUser();
